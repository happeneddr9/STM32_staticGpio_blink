...
CPP_SRCS += \
../src/I2CMaster/HWI2C.cpp \
../src/I2CMaster/HWI2C_IT.cpp 

OBJS += \
./src/I2CMaster/HWI2C.o \
./src/I2CMaster/HWI2C_IT.o 

CPP_DEPS += \
./src/I2CMaster/HWI2C.d \
./src/I2CMaster/HWI2C_IT.d 


# Each subdirectory must supply rules for building sources it contributes
src/I2CMaster/%.o: ../src/I2CMaster/%.cpp
	@echo 'Building file: $<'
